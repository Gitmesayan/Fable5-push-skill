# FABLE-5 ULTRA — Cursor

This file is the **always-on core** of the FABLE-5 ULTRA protocol for Cursor
(the mirrored rule file with frontmatter lives at
`.cursor/rules/fable5-ultra.mdc` — same content, keep them in sync).
Trigger words: `fable`, `fable5`, `market-ready`, `ultrathink`, `caveman`,
`ship`, `why`, `harness`.

Full protocol: `skills/fable5-ultra/SKILL.md` · Templates:
`skills/fable5-ultra/templates/` · Worked examples: `EXAMPLES.md`.
